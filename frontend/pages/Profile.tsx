...
import { CheckCircle, Clock, AlertTriangle, LogOut, Loader2, Download, Ticket, MapPin, Calendar, ShieldCheck, MessageSquare, FileText } from 'lucide-react';
...
const Profile: React.FC = () => {
    ...
    useEffect(() => {
        ...
        // Real-time polling for admin settings
        ...
        // Fetch IP once for ticket watermark
        fetch('/api/ip')
            .then(res => res.json())
                            ...
                            <>
                                ...
                                <div className="grid grid-cols-2 gap-2 mt-2">
                                    <button
                                        ...
                                        className="py-3 px-3 bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 shadow-md transition-all hover:scale-[1.02]"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="py-3 px-3 bg-[#20324C] hover:bg-[#2b4263] text-white rounded-xl font-bold text-xs flex items-center justify-center gap-1.5 shadow-md transition-all hover:scale-[1.02]"
                                    >
                                        <FileText size={16} />
