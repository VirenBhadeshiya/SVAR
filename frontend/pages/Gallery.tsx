      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8 relative z-10">
        <div className="bg-white p-4 shadow-xl flex flex-wrap justify-center gap-4 border border-viren-100">
          ...
          <button
            ...
            className="px-6 py-2 text-sm font-bold uppercase tracking-widest bg-gradient-to-r from-[#731515] to-amber-700 text-white shadow-md hover:shadow-lg transition-all flex items-center gap-2 rounded"
          >
